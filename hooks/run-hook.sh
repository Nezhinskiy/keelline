...
# physical paths. Empty when `git` named nothing, which is simply one anchor fewer.
git_project=
...
#
# **The UNION of the two anchors, and not either one of them.** `CLAUDE_PROJECT_DIR` reaches this
