...
`Scope:` line names the package it belongs to and the contracts it consumes and produces. The
two P0 documents here were copied from that repository, which keeps its own copies as history.
