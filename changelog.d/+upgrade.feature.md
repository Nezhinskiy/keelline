...
such as `1.0.0-rc1` included, and so is one whose version does not begin with `X.Y.Z`; nothing
is written when the plan refuses anything. A file that cannot be written part-way through stops
