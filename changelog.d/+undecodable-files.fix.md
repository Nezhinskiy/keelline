...
instead of ending the command in an internal error. So is a `keelline.toml` or machine
configuration that cannot be read at all, such as a directory at its path.
