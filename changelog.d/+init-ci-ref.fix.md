...
repository recording none gets no workflow until you write one or `keelline upgrade` (ships
later) does. Before this, an adopted configuration could be left pinning one commit in
