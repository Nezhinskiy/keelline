...
repository recording none gets no workflow until you write one or `keelline upgrade` does.
Before this, an adopted configuration could be left pinning one commit in
